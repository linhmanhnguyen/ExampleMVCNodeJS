...
router.get('/:id', authenticateToken, authorize('admin'), UserDetailController.GetUserDetailsByID);
router.put('/:id', authenticateToken, authorize('admin'), UserDetailController.UpdateUserDetail);
