...
class HistorySellAnimalsDetailRepository {
     ...
     */
    static async InsertHistory(cage_id, sellAnimals, totalWeightAnimals, historySellAnimals_id) {
        const query = `
        INSERT INTO history_sell_animals_detail (cage_id, sellAnimals, totalWeightAnimals, historySellAnimals_id) 
        VALUES (?, ?, ?, ?)`;
        const params = [cage_id, sellAnimals, totalWeightAnimals, historySellAnimals_id];
